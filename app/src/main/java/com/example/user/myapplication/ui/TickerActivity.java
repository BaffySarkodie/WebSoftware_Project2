...
import com.example.user.myapplication.ui.search.SearchActivity;
...
public class TickerActivity extends AppCompatActivity {
    ...
    private List<Ticker> readData() {
        InputStream is = getResources().openRawResource(R.raw.tickers);
    ...
    private List<ColumnHeaderModel> createColumnHeaderModelList() {
        ...
        list.add(new ColumnHeaderModel("Company Name"));
